...
// 렌더러를 만들고 초기화합니다.
void EditorMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void EditorMain::OnWindowSizeChanged()
{
...
void EditorMain::OnResuming()
{
	// TODO: 이것을 앱의 다시 시작 논리로 바꾸세요.
}

// 릴리스가 필요한 디바이스 리소스를 렌더러에 알립니다.
void EditorMain::OnDeviceRemoved()
{
